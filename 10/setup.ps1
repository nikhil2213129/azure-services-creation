...
# Use Central India for all resources
$Region = "centralindia"
write-host "Using $Region"

# Verify Azure SQL is available in this region for this subscription
...
{
    Write-Host "Azure SQL is not available in $Region for this subscription."
